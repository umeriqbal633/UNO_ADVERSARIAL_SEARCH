...
class UNOGui:
    ...
    def render_menu(self):
        ...
        prompt = self.font.render("Click anywhere to start!", True, YELLOW)
        prompt_rect = prompt.get_rect(center=(SCREEN_W // 2, SCREEN_H // 2))
        self.screen.blit(prompt, prompt_rect)

        inst = self.small_font.render("P1: Minimax-Balanced | P2: Expectimax | P3: Human (You)", True, LIGHT_BLUE)
        inst_rect = inst.get_rect(center=(SCREEN_W // 2, SCREEN_H // 2 + 50))
    ...
    def render_gameover(self):
        ...
        sub = self.font.render("Click anywhere to return to Menu", True, WHITE)
